...
var COLORS = {
  ...
  TREE: 'cyan',
  FOG:  '#DCDBDF',
  LIGHT:  { road: 'darkgray', grass: 'green', rumble: 'gray', lane: 'white'  },
  DARK:   { road: 'darkgray', grass: 'green', rumble: 'lightgray' },
  START:  { road: 'white',   grass: 'green',   rumble: 'gray'},
  FINISH: { road: 'black',   grass: 'green',   rumble: 'gray'}
};
